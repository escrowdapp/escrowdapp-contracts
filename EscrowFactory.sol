...
contract EscrowFactory {
    ...
    // function getTrustedHandlers() private view returns (address[] memory) {
    ...
    function withdraw(address payable to, address tokenAddress, uint256 amount)
        external
        payable
        trusted
    {   
    ...
    function switchActiveTrustedHandlers(
    ...
    function switchActiveTrustedTokens(address[] memory _tokens, bool approve)
        public
        trusted
    {
    ...
    function checkTrustedToken(address _token)
        public
        view
        trusted
        returns (bool)
    ...
    // recent to oldest
    function getEscrowDetailsPaging(uint256 offset)
        external
        view
        trusted
        returns (address[] memory escrowAddresses, uint256 total)
    {
        uint256 limit = 10;
